...
* The original package name 'com.insurance.insurance-policy-management-system' is invalid and this project uses 'com.insurance.insurance_policy_management_system' instead.
